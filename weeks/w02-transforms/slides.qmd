...
The table is abstract until you see one rotation written all four ways. So take a
single, concrete rotation and do exactly that.

---

## One rotation, four ways {.smaller}

Turn by **120° about the diagonal axis $(1,1,1)/\sqrt{3}$** — the axis pointing out
of the corner of a cube. Watch what it does to the three axes:
