...
Read the <span style="color:#e8743b">orange line</span> (straight leg) left to right. Undamped, the straight leg asks for tens of
...
is no direction to deliver it in. The <span style="color:#3b7dd8">blue line</span> (crouch) delivers the full 50 mm for
