...
for (px, pz), lab, dx in [((H[0], H[2]), "hip", 10), ((kx, kz), "knee", 10),
                          ((ax_, az), "ankle", 10), ((fx, fz), "sole", -38)]:
    ax.plot(px, pz, "o", ms=8, color="w", mec="k", mew=1.5, zorder=3)
    ax.annotate(lab, (px, pz), textcoords="offset points", xytext=(dx, 4), fontsize=10)
...
ax.set_xlim(-0.26, 0.30); ax.set_ylim(-0.03, 0.76); ax.set_aspect("equal")
ax.set_xlabel("x forward (m)"); ax.set_ylabel("z up (m)")
ax.set_title(r"the crouch:  $\theta_1 = -0.35$,  $\theta_2 = +0.70$", fontsize=11)
...
ax.set_xlabel("how far the sole moves (mm)")
